...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function Qs(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Wr(),fragmentShader:`
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function ea(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wr(),fragmentShader:`
...
`].filter(ai).join(`
`)),o=Fr(o),o=ca(o,t),o=ua(o,t),a=Fr(a),a=ca(a,t),a=ua(a,t),o=ha(o),a=ha(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
